...
from ..authetications_apis.utils import validate_access_token
...
async def query_api(question:str, payload: dict = Depends(validate_access_token)):
...
async def differential_diagonise_api(question:str, payload: dict = Depends(validate_access_token)):
...
async def case_simulation_api(user_input: str, payload: dict = Depends(validate_access_token)):
